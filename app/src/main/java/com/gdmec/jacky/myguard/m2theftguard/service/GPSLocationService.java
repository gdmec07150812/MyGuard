package com.gdmec.jacky.myguard.m2theftguard.service;
    ...
    private class MyListener implements LocationListener {
        public void onLocationChanged(Location location) {
            ...
            SmsManager.getDefault().
                    ...
                    sendTextMessage(safenumber, null, result, null, null);
        ...
        @Override
        public void onStatusChanged(String provider, int statsus, Bundle extras) {
